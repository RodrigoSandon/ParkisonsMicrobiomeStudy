...
add_p_col_to_csvs_in_root <- function(root_path, out_path, files_endswith_str, 
  ...
  dir.create(out_path) #uncomment if dir hasn't been created yet, else, keep commented
...
ROOT_PATH <- "/Volumes/T7Touch/NIHSummer2021/MB-PD_Association_Study_Pipeline/
              1_Pre-PRS/Part-1/sumstats"
OUT_PATH <- "/Volumes/T7Touch/NIHSummer2021/MB-PD_Association_Study_Pipeline/1_Pre-PRS/Part-1/sumstats-p/" # make sure to add "/" at the end
...
sumstats_path <- "/Volumes/T7Touch/NIHSummer2021/MB-PD_Association_Study_Pipeline/1_Pre-PRS/Part-1/sumstats-p"
